...
class FakeDataSeeder1 extends Seeder
{
    /**
    ...
    public function run()
    {
        ...
        $LevelRule=LevelRule::create(['level_id'=>$Level->id, 'name'=>$Level->name, 'rule_type'=>'1', 'fee_duration'=>'12', 'course_criteria_more_than'=>'0', 'course_criteria_less_than_equal'=>'5', 'fee_india'=>'2500', 'fee_saarc'=>'35', 'fee_rest_world'=>'100', 'status'=>'1']);
        ...
        */
    $user_id=2;
        $Application=Application::create(['application_no'=>'400001', 'level_id'=>$Level->id, 'user_id'=>$user_id, 'name'=>'Satish', 'organization'=>'Echttech', 'designation'=>'Cordinator', 'email'=>'satish@gmail.com', 'website'=>'http://www.echttech.com', 'phone_no'=>'0120797979', 'address'=>'Noida', 'city'=>'214', 'state'=>'35', 'country'=>'103', 'postal'=>'201306', 'ip'=>'', 'status'=>1]);
    ...
    $user_id=3;
        $Application=Application::create(['application_no'=>'400002', 'level_id'=>$Level->id, 'user_id'=>'3', 'name'=>'David', 'organization'=>'Demo', 'designation'=>'Cordinator', 'email'=>'aaa@gmail.com', 'website'=>'http://www.demo.com', 'phone_no'=>'0120797979', 'address'=>'Dambulla', 'city'=>'274', 'state'=>'38', 'country'=>'210', 'postal'=>'201306', 'ip'=>'', 'status'=>1]);
        $ApplicationCourse=ApplicationCourse::create(['application_id'=>$Application->id, 'level_id'=>$Level->id, 'course_id'=>'0', 'user_id'=>$user_id, 'course_name'=>'Course 1', 'course_duration'=>'12', 'eligibility'=>'yes', 'mode_of_course'=>'n/a', 'course_brief'=>'n/a', 'valid_from'=>date("Y-m-d"), 'valid_to'=>date("Y-m-d",time()+(86400*360))]);
        $ApplicationCourse=ApplicationCourse::create(['application_id'=>$Application->id, 'level_id'=>$Level->id, 'course_id'=>'0', 'user_id'=>$user_id, 'course_name'=>'Course 2', 'course_duration'=>'12', 'eligibility'=>'yes', 'mode_of_course'=>'n/a', 'course_brief'=>'n/a', 'valid_from'=>date("Y-m-d"), 'valid_to'=>date("Y-m-d",time()+(86400*360))]);
        $ApplicationCourse=ApplicationCourse::create(['application_id'=>$Application->id, 'level_id'=>$Level->id, 'course_id'=>'0', 'user_id'=>$user_id, 'course_name'=>'Course 3', 'course_duration'=>'12', 'eligibility'=>'yes', 'mode_of_course'=>'n/a', 'course_brief'=>'n/a', 'valid_from'=>date("Y-m-d"), 'valid_to'=>date("Y-m-d",time()+(86400*360))]);
        $ApplicationCourse=ApplicationCourse::create(['application_id'=>$Application->id, 'level_id'=>$Level->id, 'course_id'=>'0', 'user_id'=>$user_id, 'course_name'=>'Course 4', 'course_duration'=>'12', 'eligibility'=>'yes', 'mode_of_course'=>'n/a', 'course_brief'=>'n/a', 'valid_from'=>date("Y-m-d"), 'valid_to'=>date("Y-m-d",time()+(86400*360))]);
    ...
    $user_id=4;
        $Application=Application::create(['application_no'=>'400003', 'level_id'=>$Level->id, 'user_id'=>'4', 'name'=>'Daksh', 'organization'=>'Demo', 'designation'=>'Cordinator', 'email'=>'bbb@gmail.com', 'website'=>'http://www.demo.com', 'phone_no'=>'0120797979', 'address'=>'Dambulla', 'city'=>'214', 'state'=>'35', 'country'=>'103', 'postal'=>'201306', 'ip'=>'', 'status'=>2]);
        $ApplicationCourse=ApplicationCourse::create(['application_id'=>$Application->id, 'level_id'=>$Level->id, 'course_id'=>'0', 'user_id'=>$user_id, 'course_name'=>'Course 1', 'course_duration'=>'12', 'eligibility'=>'yes', 'mode_of_course'=>'n/a', 'course_brief'=>'n/a', 'valid_from'=>date("Y-m-d"), 'valid_to'=>date("Y-m-d",time()+(86400*360))]);
        $ApplicationCourse=ApplicationCourse::create(['application_id'=>$Application->id, 'level_id'=>$Level->id, 'course_id'=>'0', 'user_id'=>$user_id, 'course_name'=>'Course 2', 'course_duration'=>'12', 'eligibility'=>'yes', 'mode_of_course'=>'n/a', 'course_brief'=>'n/a', 'valid_from'=>date("Y-m-d"), 'valid_to'=>date("Y-m-d",time()+(86400*360))]);
        $ApplicationCourse=ApplicationCourse::create(['application_id'=>$Application->id, 'level_id'=>$Level->id, 'course_id'=>'0', 'user_id'=>$user_id, 'course_name'=>'Course 3', 'course_duration'=>'12', 'eligibility'=>'yes', 'mode_of_course'=>'n/a', 'course_brief'=>'n/a', 'valid_from'=>date("Y-m-d"), 'valid_to'=>date("Y-m-d",time()+(86400*360))]);
        $ApplicationCourse=ApplicationCourse::create(['application_id'=>$Application->id, 'level_id'=>$Level->id, 'course_id'=>'0', 'user_id'=>$user_id, 'course_name'=>'Course 4', 'course_duration'=>'12', 'eligibility'=>'yes', 'mode_of_course'=>'n/a', 'course_brief'=>'n/a', 'valid_from'=>date("Y-m-d"), 'valid_to'=>date("Y-m-d",time()+(86400*360))]);
    ...
    $user_id=5;
        $Application=Application::create(['application_no'=>'400004', 'level_id'=>$Level->id, 'user_id'=>'5', 'name'=>'Rohit', 'organization'=>'Demo', 'designation'=>'Cordinator', 'email'=>'ccc@gmail.com', 'website'=>'http://www.demo.com', 'phone_no'=>'0120797979', 'address'=>'California', 'city'=>'236', 'state'=>'43', 'country'=>'275', 'postal'=>'201306', 'ip'=>'', 'status'=>1]);
        $ApplicationCourse=ApplicationCourse::create(['application_id'=>$Application->id, 'level_id'=>$Level->id, 'course_id'=>'0', 'user_id'=>$user_id, 'course_name'=>'Course 1', 'course_duration'=>'12', 'eligibility'=>'yes', 'mode_of_course'=>'n/a', 'course_brief'=>'n/a', 'valid_from'=>date("Y-m-d"), 'valid_to'=>date("Y-m-d",time()+(86400*360))]);
        $ApplicationCourse=ApplicationCourse::create(['application_id'=>$Application->id, 'level_id'=>$Level->id, 'course_id'=>'0', 'user_id'=>$user_id, 'course_name'=>'Course 2', 'course_duration'=>'12', 'eligibility'=>'yes', 'mode_of_course'=>'n/a', 'course_brief'=>'n/a', 'valid_from'=>date("Y-m-d"), 'valid_to'=>date("Y-m-d",time()+(86400*360))]);
        $ApplicationCourse=ApplicationCourse::create(['application_id'=>$Application->id, 'level_id'=>$Level->id, 'course_id'=>'0', 'user_id'=>$user_id, 'course_name'=>'Course 3', 'course_duration'=>'12', 'eligibility'=>'yes', 'mode_of_course'=>'n/a', 'course_brief'=>'n/a', 'valid_from'=>date("Y-m-d"), 'valid_to'=>date("Y-m-d",time()+(86400*360))]);
        $ApplicationCourse=ApplicationCourse::create(['application_id'=>$Application->id, 'level_id'=>$Level->id, 'course_id'=>'0', 'user_id'=>$user_id, 'course_name'=>'Course 4', 'course_duration'=>'12', 'eligibility'=>'yes', 'mode_of_course'=>'n/a', 'course_brief'=>'n/a', 'valid_from'=>date("Y-m-d"), 'valid_to'=>date("Y-m-d",time()+(86400*360))]);
    ...
    $user_id=6;
        $Application=Application::create(['application_no'=>'400005', 'level_id'=>$Level->id, 'user_id'=>'6', 'name'=>'Mike', 'organization'=>'Demo', 'designation'=>'Cordinator', 'email'=>'ddd@gmail.com', 'website'=>'http://www.demo.com', 'phone_no'=>'0120797979', 'address'=>'California', 'city'=>'236', 'state'=>'43', 'country'=>'275', 'postal'=>'201306', 'ip'=>'', 'status'=>0]);
        $ApplicationCourse=ApplicationCourse::create(['application_id'=>$Application->id, 'level_id'=>$Level->id, 'course_id'=>'0', 'user_id'=>$user_id, 'course_name'=>'Course 1', 'course_duration'=>'12', 'eligibility'=>'yes', 'mode_of_course'=>'n/a', 'course_brief'=>'n/a', 'valid_from'=>date("Y-m-d"), 'valid_to'=>date("Y-m-d",time()+(86400*360))]);
        $ApplicationCourse=ApplicationCourse::create(['application_id'=>$Application->id, 'level_id'=>$Level->id, 'course_id'=>'0', 'user_id'=>$user_id, 'course_name'=>'Course 2', 'course_duration'=>'12', 'eligibility'=>'yes', 'mode_of_course'=>'n/a', 'course_brief'=>'n/a', 'valid_from'=>date("Y-m-d"), 'valid_to'=>date("Y-m-d",time()+(86400*360))]);
        $ApplicationCourse=ApplicationCourse::create(['application_id'=>$Application->id, 'level_id'=>$Level->id, 'course_id'=>'0', 'user_id'=>$user_id, 'course_name'=>'Course 3', 'course_duration'=>'12', 'eligibility'=>'yes', 'mode_of_course'=>'n/a', 'course_brief'=>'n/a', 'valid_from'=>date("Y-m-d"), 'valid_to'=>date("Y-m-d",time()+(86400*360))]);
        $ApplicationCourse=ApplicationCourse::create(['application_id'=>$Application->id, 'level_id'=>$Level->id, 'course_id'=>'0', 'user_id'=>$user_id, 'course_name'=>'Course 4', 'course_duration'=>'12', 'eligibility'=>'yes', 'mode_of_course'=>'n/a', 'course_brief'=>'n/a', 'valid_from'=>date("Y-m-d"), 'valid_to'=>date("Y-m-d",time()+(86400*360))]);
    ...
    $user_id=7;
        $Application=Application::create(['application_no'=>'400006', 'level_id'=>$Level->id, 'user_id'=>'7', 'name'=>'Sandy', 'organization'=>'Demo', 'designation'=>'Cordinator', 'email'=>'eee@gmail.com', 'website'=>'http://www.demo.com', 'phone_no'=>'0120797979', 'address'=>'California', 'city'=>'236', 'state'=>'43', 'country'=>'275', 'postal'=>'201306', 'ip'=>'', 'status'=>0]);
        $ApplicationCourse=ApplicationCourse::create(['application_id'=>$Application->id, 'level_id'=>$Level->id, 'course_id'=>'0', 'user_id'=>$user_id, 'course_name'=>'Course 1', 'course_duration'=>'12', 'eligibility'=>'yes', 'mode_of_course'=>'n/a', 'course_brief'=>'n/a', 'valid_from'=>date("Y-m-d"), 'valid_to'=>date("Y-m-d",time()+(86400*360))]);
        $ApplicationCourse=ApplicationCourse::create(['application_id'=>$Application->id, 'level_id'=>$Level->id, 'course_id'=>'0', 'user_id'=>$user_id, 'course_name'=>'Course 2', 'course_duration'=>'12', 'eligibility'=>'yes', 'mode_of_course'=>'n/a', 'course_brief'=>'n/a', 'valid_from'=>date("Y-m-d"), 'valid_to'=>date("Y-m-d",time()+(86400*360))]);
        $ApplicationCourse=ApplicationCourse::create(['application_id'=>$Application->id, 'level_id'=>$Level->id, 'course_id'=>'0', 'user_id'=>$user_id, 'course_name'=>'Course 3', 'course_duration'=>'12', 'eligibility'=>'yes', 'mode_of_course'=>'n/a', 'course_brief'=>'n/a', 'valid_from'=>date("Y-m-d"), 'valid_to'=>date("Y-m-d",time()+(86400*360))]);
        $ApplicationCourse=ApplicationCourse::create(['application_id'=>$Application->id, 'level_id'=>$Level->id, 'course_id'=>'0', 'user_id'=>$user_id, 'course_name'=>'Course 4', 'course_duration'=>'12', 'eligibility'=>'yes', 'mode_of_course'=>'n/a', 'course_brief'=>'n/a', 'valid_from'=>date("Y-m-d"), 'valid_to'=>date("Y-m-d",time()+(86400*360))]);
    ...
    $user_id=8;
        $Application=Application::create(['application_no'=>'400007', 'level_id'=>$Level->id, 'user_id'=>'8', 'name'=>'Loin', 'organization'=>'Demo', 'designation'=>'Cordinator', 'email'=>'fff@gmail.com', 'website'=>'http://www.demo.com', 'phone_no'=>'0120797979', 'address'=>'Noida', 'city'=>'214', 'state'=>'35', 'country'=>'103', 'postal'=>'201306', 'ip'=>'', 'status'=>1]);
        $ApplicationCourse=ApplicationCourse::create(['application_id'=>$Application->id, 'level_id'=>$Level->id, 'course_id'=>'0', 'user_id'=>$user_id, 'course_name'=>'Course 1', 'course_duration'=>'12', 'eligibility'=>'yes', 'mode_of_course'=>'n/a', 'course_brief'=>'n/a', 'valid_from'=>date("Y-m-d"), 'valid_to'=>date("Y-m-d",time()+(86400*360))]);
        $ApplicationCourse=ApplicationCourse::create(['application_id'=>$Application->id, 'level_id'=>$Level->id, 'course_id'=>'0', 'user_id'=>$user_id, 'course_name'=>'Course 2', 'course_duration'=>'12', 'eligibility'=>'yes', 'mode_of_course'=>'n/a', 'course_brief'=>'n/a', 'valid_from'=>date("Y-m-d"), 'valid_to'=>date("Y-m-d",time()+(86400*360))]);
        $ApplicationCourse=ApplicationCourse::create(['application_id'=>$Application->id, 'level_id'=>$Level->id, 'course_id'=>'0', 'user_id'=>$user_id, 'course_name'=>'Course 3', 'course_duration'=>'12', 'eligibility'=>'yes', 'mode_of_course'=>'n/a', 'course_brief'=>'n/a', 'valid_from'=>date("Y-m-d"), 'valid_to'=>date("Y-m-d",time()+(86400*360))]);
        $ApplicationCourse=ApplicationCourse::create(['application_id'=>$Application->id, 'level_id'=>$Level->id, 'course_id'=>'0', 'user_id'=>$user_id, 'course_name'=>'Course 4', 'course_duration'=>'12', 'eligibility'=>'yes', 'mode_of_course'=>'n/a', 'course_brief'=>'n/a', 'valid_from'=>date("Y-m-d"), 'valid_to'=>date("Y-m-d",time()+(86400*360))]);
    ...
    $user_id=9;
        $Application=Application::create(['application_no'=>'400008', 'level_id'=>$Level->id, 'user_id'=>'9', 'name'=>'Rowart', 'organization'=>'Demo', 'designation'=>'Cordinator', 'email'=>'ggg@gmail.com', 'website'=>'http://www.demo.com', 'phone_no'=>'0120797979', 'address'=>'Noida', 'city'=>'214', 'state'=>'35', 'country'=>'103', 'postal'=>'201306', 'ip'=>'', 'status'=>0]);
        $ApplicationCourse=ApplicationCourse::create(['application_id'=>$Application->id, 'level_id'=>$Level->id, 'course_id'=>'0', 'user_id'=>$user_id, 'course_name'=>'Course 1', 'course_duration'=>'12', 'eligibility'=>'yes', 'mode_of_course'=>'n/a', 'course_brief'=>'n/a', 'valid_from'=>date("Y-m-d"), 'valid_to'=>date("Y-m-d",time()+(86400*360))]);
        $ApplicationCourse=ApplicationCourse::create(['application_id'=>$Application->id, 'level_id'=>$Level->id, 'course_id'=>'0', 'user_id'=>$user_id, 'course_name'=>'Course 2', 'course_duration'=>'12', 'eligibility'=>'yes', 'mode_of_course'=>'n/a', 'course_brief'=>'n/a', 'valid_from'=>date("Y-m-d"), 'valid_to'=>date("Y-m-d",time()+(86400*360))]);
        $ApplicationCourse=ApplicationCourse::create(['application_id'=>$Application->id, 'level_id'=>$Level->id, 'course_id'=>'0', 'user_id'=>$user_id, 'course_name'=>'Course 3', 'course_duration'=>'12', 'eligibility'=>'yes', 'mode_of_course'=>'n/a', 'course_brief'=>'n/a', 'valid_from'=>date("Y-m-d"), 'valid_to'=>date("Y-m-d",time()+(86400*360))]);
        $ApplicationCourse=ApplicationCourse::create(['application_id'=>$Application->id, 'level_id'=>$Level->id, 'course_id'=>'0', 'user_id'=>$user_id, 'course_name'=>'Course 4', 'course_duration'=>'12', 'eligibility'=>'yes', 'mode_of_course'=>'n/a', 'course_brief'=>'n/a', 'valid_from'=>date("Y-m-d"), 'valid_to'=>date("Y-m-d",time()+(86400*360))]);
    ...
    $user_id=10;
        $Application=Application::create(['application_no'=>'400009', 'level_id'=>$Level->id, 'user_id'=>'10', 'name'=>'Pankaj', 'organization'=>'Demo', 'designation'=>'Cordinator', 'email'=>'hhh@gmail.com', 'website'=>'http://www.demo.com', 'phone_no'=>'0120797979', 'address'=>'Noida', 'city'=>'214', 'state'=>'35', 'country'=>'103', 'postal'=>'201306', 'ip'=>'', 'status'=>1]);
        $ApplicationCourse=ApplicationCourse::create(['application_id'=>$Application->id, 'level_id'=>$Level->id, 'course_id'=>'0', 'user_id'=>$user_id, 'course_name'=>'Course 1', 'course_duration'=>'12', 'eligibility'=>'yes', 'mode_of_course'=>'n/a', 'course_brief'=>'n/a', 'valid_from'=>date("Y-m-d"), 'valid_to'=>date("Y-m-d",time()+(86400*360))]);
        $ApplicationCourse=ApplicationCourse::create(['application_id'=>$Application->id, 'level_id'=>$Level->id, 'course_id'=>'0', 'user_id'=>$user_id, 'course_name'=>'Course 2', 'course_duration'=>'12', 'eligibility'=>'yes', 'mode_of_course'=>'n/a', 'course_brief'=>'n/a', 'valid_from'=>date("Y-m-d"), 'valid_to'=>date("Y-m-d",time()+(86400*360))]);
        $ApplicationCourse=ApplicationCourse::create(['application_id'=>$Application->id, 'level_id'=>$Level->id, 'course_id'=>'0', 'user_id'=>$user_id, 'course_name'=>'Course 3', 'course_duration'=>'12', 'eligibility'=>'yes', 'mode_of_course'=>'n/a', 'course_brief'=>'n/a', 'valid_from'=>date("Y-m-d"), 'valid_to'=>date("Y-m-d",time()+(86400*360))]);
        $ApplicationCourse=ApplicationCourse::create(['application_id'=>$Application->id, 'level_id'=>$Level->id, 'course_id'=>'0', 'user_id'=>$user_id, 'course_name'=>'Course 4', 'course_duration'=>'12', 'eligibility'=>'yes', 'mode_of_course'=>'n/a', 'course_brief'=>'n/a', 'valid_from'=>date("Y-m-d"), 'valid_to'=>date("Y-m-d",time()+(86400*360))]);
        ...
        $user_id=11;
        $Application=Application::create(['application_no'=>'400010', 'level_id'=>$Level->id, 'user_id'=>'2', 'name'=>'Satish', 'organization'=>'Demo', 'designation'=>'Cordinator', 'email'=>'satish@gmail.com', 'website'=>'http://www.echttech.com', 'phone_no'=>'0120797979', 'address'=>'Noida', 'city'=>'214', 'state'=>'35', 'country'=>'103', 'postal'=>'201306', 'ip'=>'', 'status'=>0]);
        $ApplicationCourse=ApplicationCourse::create(['application_id'=>$Application->id, 'level_id'=>$Level->id, 'course_id'=>'0', 'user_id'=>$user_id, 'course_name'=>'Course 1', 'course_duration'=>'12', 'eligibility'=>'yes', 'mode_of_course'=>'n/a', 'course_brief'=>'n/a', 'valid_from'=>date("Y-m-d"), 'valid_to'=>date("Y-m-d",time()+(86400*360))]);
        $ApplicationCourse=ApplicationCourse::create(['application_id'=>$Application->id, 'level_id'=>$Level->id, 'course_id'=>'0', 'user_id'=>$user_id, 'course_name'=>'Course 2', 'course_duration'=>'12', 'eligibility'=>'yes', 'mode_of_course'=>'n/a', 'course_brief'=>'n/a', 'valid_from'=>date("Y-m-d"), 'valid_to'=>date("Y-m-d",time()+(86400*360))]);
        $ApplicationCourse=ApplicationCourse::create(['application_id'=>$Application->id, 'level_id'=>$Level->id, 'course_id'=>'0', 'user_id'=>$user_id, 'course_name'=>'Course 3', 'course_duration'=>'12', 'eligibility'=>'yes', 'mode_of_course'=>'n/a', 'course_brief'=>'n/a', 'valid_from'=>date("Y-m-d"), 'valid_to'=>date("Y-m-d",time()+(86400*360))]);
        $ApplicationCourse=ApplicationCourse::create(['application_id'=>$Application->id, 'level_id'=>$Level->id, 'course_id'=>'0', 'user_id'=>$user_id, 'course_name'=>'Course 4', 'course_duration'=>'12', 'eligibility'=>'yes', 'mode_of_course'=>'n/a', 'course_brief'=>'n/a', 'valid_from'=>date("Y-m-d"), 'valid_to'=>date("Y-m-d",time()+(86400*360))]);
