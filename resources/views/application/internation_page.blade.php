                                        ...
                                        <div class="body">
                                            <div class="table-responsive">
                                                ...
                                                <a href="{{ url('preveious-app-status/'.dEncrypt($item->id)) }}" onclick="return confirm_option('change status')"
                                                    @if($item->status == 0)<div class="badge col-black">Pending</div> @elseif( $item->status == 1) <div class="badge col-green">InProccess</div> @else    @endif
                                                    </a>
                                                </td>
                                           ...
                                           @if($item->status == '1')
                                            ...
                                            @endif
                                                            ...
                                                            <td class="center">
                                                                <a href="{{ url('/admin-view') }}" class="btn btn-tbl-edit mb-0"><i class="material-icons">visibility</i></a>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-hover js-basic-example contact_list">
                                           ...
                                           @if($item->status == '1')
                                            ...
                                            <a href="{{ url('preveious-app-status/'.dEncrypt($item->id))}}" onclick="return confirm_option('change status')"
                                                @if($item->status == 1)<div class="badge col-green">InProccess</div> @elseif( $item->status == 2) <div class="badge col-green">Approved</div> @else    @endif
                                                </a>
                                            </td>
