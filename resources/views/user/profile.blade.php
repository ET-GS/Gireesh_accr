                                            ...
                                            <div class="form-line">
                                                ...
                                                <select name="title" class="form-control" id="title">
                                                    ...
                                                    <option value="Ms" {{ $data->title == 'Ms' ? 'selected' : '' }}>
                                                        Ms.</option>
                                                    <option value="Dr" {{ $data->title == 'Dr' ? 'selected' : '' }}>
                                                        Dr.</option>
                                                    <option value="Vd"
                                                        {{ $data->title == 'Vd' ? 'selected' : '' }}>Vd.</option>
                                                </select>
                                            </div>
                                        ...
                                        <div class="form-group">
                                            <div class="form-line">
                                                ...
                                                <input type="text" placeholder="Enter Mob No." name="mobile_no"
                                                    id="mobile_no" value="{{ $data->mobile_no }}" maxlength="10"
                                                    readonly>
                                            </div>
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            <div class="form-line">
                                                ...
                                                <input type="text" minlength="2" maxlength="6"   name="postal" id="postal"
                            ...
                            <div class="form-group">
                                <div class="form-line">
                                    ...
                                    <select name="status" class="form-control" id="status">
                                        <option value="">Select Title</option>
                                        <option value="0"
                                            {{ $data->status == '0' ? 'selected' : '' }}>Active
                                        </option>
                                        <option value="1"
                                            {{ $data->status == '1' ? 'selected' : '' }}>Inactive
                                        </option>
                                    </select>
                                </div>
