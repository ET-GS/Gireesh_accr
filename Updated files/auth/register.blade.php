    ...
    <body>
        ...
        <div class="form-container">
            ...
            <form  action="{{ url('/register') }}"  method="post" class="form" id="regForm" >
                ...
                <div class="iconInput email">
                    <input type="text" class="input_otp" name="email_otp" id="email_otp" value="{{ old('email_otp') }}" minlength="2" maxlength="6" id="mobile_no" placeholder="Email OTP">
                ...
                <div class="iconInput_container">
                    <label  class="label_input"> City<span class="text-danger">*</span></label><label  class="label_input" style="margin:0px 0 0 111px"> Pincode<span class="text-danger"></span></label>
                <div class="iconInput email">
                ...
                <div class="iconInput_container">
                    ...
                    <span class="icon icon-t top-tip d-none">
                        ...
                        <b>Your password must satisfy the following:</b><br>
                            ...
                            <li>Password must be 8 to 13 character long.</li>
